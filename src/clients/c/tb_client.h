...
typedef enum TB_TRANSFER_FLAGS {
    ...
    TB_TRANSFER_ENABLE_HISTORY_DEBIT = 1 << 9,
    TB_TRANSFER_ENABLE_HISTORY_CREDIT = 1 << 10,
    TB_TRANSFER_ENABLE_BALANCE_LIMIT_DEBIT = 1 << 11,
    TB_TRANSFER_ENABLE_BALANCE_LIMIT_CREDIT = 1 << 12,
} TB_TRANSFER_FLAGS;
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_UPGRADE_TRANSFER_MUST_BE_PENDING = 69,
    TB_CREATE_TRANSFER_UPGRADE_DEBIT_ACCOUNT_BALANCE_EXCEEDS_LIMIT = 70,
    TB_CREATE_TRANSFER_UPGRADE_CREDIT_ACCOUNT_BALANCE_EXCEEDS_LIMIT = 71,
    TB_CREATE_TRANSFER_IMPORTED_PENDING_TIMESTAMP_MUST_NOT_REGRESS = 72,
    TB_CREATE_TRANSFER_IMPORTED_PENDING_TIMESTAMP_MUST_POSTDATE_DEBIT_ACCOUNT = 73,
    TB_CREATE_TRANSFER_IMPORTED_PENDING_TIMESTAMP_MUST_POSTDATE_CREDIT_ACCOUNT = 74,
    TB_CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_BE_UNIQUE = 75,
